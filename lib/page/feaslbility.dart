...
class Feaslbility extends StatefulWidget {
  const Feaslbility({Key key}) : super(key: key);

  @override
  State<Feaslbility> createState() => _FeaslbilityState();
}

class _FeaslbilityState extends State<Feaslbility> {
  int selectedRadio;
                        ...
                        Container(
                          ...
                          child: TextField(
                            decoration: InputDecoration(
                              contentPadding: new EdgeInsets.only(left: 10,bottom: 8),
                              border: InputBorder.none,
                              hintText: AppLocalizations.of(context).uploud1,
                    hintStyle: const TextStyle(
                        fontSize: 17,
                        color: const Color(0xff999999),
                        fontWeight: FontWeight.w500),
                        ...
                        Container(
                          ...
                          child: TextField(
                            decoration: InputDecoration(
                              contentPadding: new EdgeInsets.only(left: 10,bottom: 8),
                              border: InputBorder.none,
                              hintText: AppLocalizations.of(context).uploud2,
                    hintStyle: const TextStyle(
                        fontSize: 17,
                        color: const Color(0xff999999),
                        fontWeight: FontWeight.w500),
